...
public class MoveRightServo extends CommandBase {
  private final SimRightServoClaw m_claw;
  public int max = 180;
  public int min = 1;
  /** Creates a new MoveServo. */
  public MoveRightServo(SimRightServoClaw claw) {
