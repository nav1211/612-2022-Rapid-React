...
import frc.robot.sim.Climb.SimRightSolenoid;

public class SimRightPiston extends SubsystemBase {
  private final SimRightSolenoid m_simSolenoid;
  private final ShuffleboardTab tab;
  private final NetworkTableEntry solenoidEntry;
  /** Creates a new SimPiston. */
  public SimRightPiston() {
    m_simSolenoid = new SimRightSolenoid(8, PneumaticsModuleType.CTREPCM, 1, 0);
    tab = Shuffleboard.getTab("ClimbSolenoid");
    solenoidEntry = tab.add("RightSolenoid", "off").getEntry();
  }
